...
public class ConeVision : MonoBehaviour
{
    ...
    void DrawVisionCone()//this method creates the vision cone mesh
    {
        ...
        Vector2[] Vertices = new Vector2[VisionConeResolution + 1];
        ...
        for (int i = 0; i < VisionConeResolution; i++)
        {
            ...
            Vector2 RaycastDirection = (transform.forward * Cosine) + (transform.right * Sine);
            Vector2 VertForward = (Vector2.left * Cosine) + (Vector2.up * Sine);
